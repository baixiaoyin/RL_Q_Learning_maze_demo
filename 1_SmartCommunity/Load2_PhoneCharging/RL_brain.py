...
class RL(object):
    def __init__(self, action_space, learning_rate=1, reward_decay=0.9, e_greedy=0.9, TimeSlots=HE.TotalTime):
...
class QLearningTable(RL):
    def __init__(self, actions, learning_rate=1, reward_decay=0.0001, e_greedy=0.9): #?? Reward Decay ?= 1??
